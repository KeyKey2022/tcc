                        ...
                        while ($row = mysqli_fetch_assoc($ob)){
                            ...
                            <tr>
                                ...
                                <td style="text-align: center">
                                    <a href="product_details.php?id=<?= $row['id']?>" class="btn btn-info">Ver</a>
                                    <a href="logout.php?poid=<?= $row['id']?>&page=wishlist" class="btn btn-danger" onclick="return confirm('Voce tem a certeza ?')" >Deletar</a>
                                </td>
                            </tr>
                        <?php  }  }?>
