            ...
            <div class="row">
                ...
                <div class="span9">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Pagina de Pedidos</li>
                    </ul>
                    <?php
                    ...
                    <table class="table-bordered table">
                        ...
                        <?php } else{ ?>
                        <h3 style="text-align: center;color: red;margin-top: 100px;">A página do pedido é zero.</h3>
                        <div style="text-align: center">
                        <a href="index.php" class="btn btn-info">Ir para a pagina de compras</a></div>
                            <?php } ?>
                </div>
            </div></div>
    </div>
