            ...
            <div class="row">
                ...
                <div class="span9">
                    <div class="well well-small">
                        <h4>Featured Products <small class="pull-right"><?=  \App\classes\Product::countFeatureProduct()-1?>+&nbsp;produtos em destaque</small></h4>
                        <div class="row-fluid">
                            <div class="item">
                                <ul class="thumbnails">
                                    <?php
                                        ...
                                        <li class="span3">
                                            <div class="thumbnail">
                                                ...
                                                <div class="caption">
                                                    ...
                                                    <h4><a class="btn" href="product_details.php?id=<?= $Fproduct['id'] ?>">VER</a> <span class="pull-right"><?= $Fproduct['price'] ?> Kz</span></h4>
                                                </div>
                                            </div>
                                        </li>
                                    <?php } ?>
                            ...
                            <li class="span3">
                                <div class="thumbnail">
                                    ...
                                    <div class="caption">
                                        ...
                                        <h4 style="text-align:center"> <a class="btn" href="product_details.php?id=<?= $Aproduct['id'] ?>">VER</a> <a class="btn" href="#">Add Para <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#"><?= $Aproduct['price'] ?> Kz</a></h4>
                                    </div>
                                </div>
                            </li>
                        <?php } ?>
                    ...
                    <div class="pagination" style="text-align: right;">
                        <ul>
                            <?php if ($page>1){ ?>
                                <li><a href="index.php?page=<?=$page - 1;?>""> Voltar</a></li>
                            <?php } ?>
                            <?php
                            ...
                            <?php if($totalpage > $page) { ?>
                                <li><a href="index.php?page=<?=$page + 1;?>">Proximo</a></li>
                            <?php } ?>
                        </ul>
                    </div>
                </div>
