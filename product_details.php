        ...
        <div class="row">
            ...
            <div class="span9">
                <ul class="breadcrumb">
                    ...
                    <li><a href="products.php">Produtos</a> <span class="divider">/</span></li>
                ...
                <div class="row">
                    ...
                    <div class="span6">
                        ...
                        <form class="form-horizontal qtyFrm" method="post">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <a href="?id=<?=$Sproduct['id']?>&compare" class="btn btn-info">Adicionar para comparar</a>
                                    <a href="?id=<?=$Sproduct['id']?>&wishlist" class="btn btn-warning">Adicionar na lista de desejos</a>
                                    </div>
                                        <?php } ?>
                                </div>
                            </div>
                        ...
                        <hr class="soft"/>
                        <h4><?=$Sproduct['quantity']?> items em stock</h4>
                        <hr>
