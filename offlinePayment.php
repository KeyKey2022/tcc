            ...
            <div class="row">
                ...
                <div class="span9">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Pagamento Offline</li>
                    </ul>
                    ...
                    <form class="form-horizontal"method="post" action="">
                        ...
                        <div class="control-group">
                            <label class="control-label" for="inputFname1">Cidade <sup>*</sup></label>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="zip" placeholder="Codigo Zip" value="<?= $cusDetails['zip']?>">
                            </div>
                        </div><div class="control-group">
                            <label class="control-label" for="inputFname1">Endereço <sup>*</sup></label>
                            <div class="controls">
                                <input type="text" name="address" placeholder="Address"value="<?= $cusDetails['address']?>">
                            </div>
                        </div><div class="control-group">
                            <label class="control-label" for="inputFname1">País <sup>*</sup></label>
                            <div class="controls">
                    ...
                    <a href="?order" class="btn btn-info">Confirmar Pedido</a>
                    </div>
                </div>
            </div></div>
    </div>
