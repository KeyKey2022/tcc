	...
	<div class="tab-pane" id="listView">
		...
		<div class="row">	  
			...
			<div class="span4">
				...
				<a class="btn btn-small pull-right" href="product_details.php?id=<?= $Cpro['id'] ?>">Visualizar Detalhes</a>
				<br class="clr"/>
			</div>
			<div class="span3 alignR">
			<form class="form-horizontal qtyFrm">
			<h3> $ <?= $Cpro['price'] ?></h3>
			  <a href="product_details.html" class="btn btn-large btn-primary"> Adicionar  <i class=" icon-shopping-cart"></i></a>
			  ...
			  <div class="thumbnail">
				...
				<div class="caption">
				  <h5><?= $Cpro['name'] ?></h5>
                    ...
                    <h4><a class="btn" href="product_details.php?id=<?= $Cpro['id'] ?>">ver</a> <span class="pull-right"> <?= $Cpro['price'] ?>Kz</span></h4>
				</div>
			  </div>
			</li>
<?php } ?>
