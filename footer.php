...
<!-- Footer ================================================================== -->
	...
	<div class="container">
		<div class="row">
			<div class="span3">
				<h5>CONTA</h5>
				<a href="login.php">SUA CONTA</a>
				<a href="login.php">PERSONAL INFORMATION</a>
				<a href="login.php">ENDEREÇOS</a>
				<a href="login.php">DESCONTO</a>
				<a href="login.php">HISTÓRICO DE PEDIDOS</a>
			 </div>
			<div class="span3">
				<h5>INFORMAÇÕES</h5>
				<a href="contact.php">CONTACTOS</a>
				<a href="register.php">CADASTRO</a>
				<a href="legal_notice.html">NOVIDADES</a>  
		...
		<p class="pull-right">&copy; ZEFESHOP</p>
	</div><!-- Container End -->
	</div>
